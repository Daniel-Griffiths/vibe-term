...
contextBridge.exposeInMainWorld('electronAPI', {
  startAiProcess: (...args: any[]) => 
    ipcRenderer.invoke('start-ai-process', ...args),

  aiHook: (...args: any[]) => 
    ipcRenderer.invoke('ai-hook', ...args),

  stopAiProcess: (...args: any[]) => 
    ipcRenderer.invoke('stop-ai-process', ...args),
  ...
  getAiProviders: (...args: any[]) => 
    ipcRenderer.invoke('get-ai-providers', ...args),

  checkAiProvider: (...args: any[]) => 
    ipcRenderer.invoke('check-ai-provider', ...args),
