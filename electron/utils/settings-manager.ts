...
export class SettingsManager {
  ...
  /**
   * Cache AI provider availability
   */
  cacheAiProviderAvailability(availability: Record<string, boolean>): void {
    this.appState.settings = {
      ...this.appState.settings,
      ai: {
        ...this.appState.settings.ai,
  ...
  /**
   * Get cached AI provider availability
   */
  getAiProviderAvailability(): Record<string, boolean> | undefined {
    return this.appState.settings.ai?.providerAvailability;
  }
}
