...
class API {
  ...
  async startAiProcess(arg0: string, arg1: string, arg2?: string, arg3?: string, arg4?: boolean): Promise<PTYResult> {
    return isElectron 
      ? this.electronAPI.startAiProcess(arg0, arg1, arg2, arg3, arg4)
      : this.callAPI('start-ai-process', [arg0, arg1, arg2, arg3, arg4]);
  }

  async aiHook(arg0: string, arg1: string): Promise<BaseResponse> {
    return isElectron 
      ? this.electronAPI.aiHook(arg0, arg1)
      : this.callAPI('ai-hook', [arg0, arg1]);
  }

  async stopAiProcess(arg0: string): Promise<BaseResponse> {
    return isElectron 
      ? this.electronAPI.stopAiProcess(arg0)
      : this.callAPI('stop-ai-process', [arg0]);
  }
  ...
  async updateAppSettings(settings: Partial<AppSettings>): Promise<BaseResponse> {
    return isElectron 
      ? this.electronAPI.updateAppSettings(settings)
      : this.callAPI('update-app-settings', [settings]);
  }

  async getAiProviders(): Promise<any> {
    return isElectron 
      ? this.electronAPI.getAiProviders()
      : this.callAPI('get-ai-providers', []);
  }

  async checkAiProvider(): Promise<any> {
    return isElectron 
      ? this.electronAPI.checkAiProvider()
      : this.callAPI('check-ai-provider', []);
  }
